...
export class DisciplinaFormComponent implements OnInit {
  ...
  async ngOnInit(): Promise<void> {
    ...
    try {
      ...
      this.form.setValue({ codigo: disciplina.codigo, nome: disciplina.nome });
    } catch (e) {
  ...
  async salvar(): Promise<void> {
    ...
    try {
      ...
      if (this.id() != null) {
        await this.disciplinaService.atualizar(this.id()!, request);
      } else {
        await this.disciplinaService.criar(request);
      }
      this.voltar();
    } catch (e) {
